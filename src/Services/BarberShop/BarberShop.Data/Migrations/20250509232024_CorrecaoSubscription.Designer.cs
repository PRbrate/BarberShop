...
namespace BarberShop.Data.Migrations
{
    ...
    [Migration("20250509232024_CorrecaoSubscription")]
    partial class CorrecaoSubscription
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BarberShop.Domain.Haircut", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BarberShop.Domain.Subscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BarberShop.Domain.Service", b =>
                {
                    b.HasOne("BarberShop.Domain.Haircut", "Haircut")
                        .WithMany("Services")
            ...
            modelBuilder.Entity("BarberShop.Domain.Subscription", b =>
                {
                    b.HasOne("BarberShop.Domain.User", "User")
                        ...
                        .HasForeignKey("BarberShop.Domain.Subscription", "UserId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BarberShop.Domain.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
